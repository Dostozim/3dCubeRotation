...
while po < 30000:
      ...
      front=[nodes[2], nodes[6], nodes[4], nodes[0]]
      back = [nodes[3], nodes[1], nodes[5], nodes[7]]
      down=[nodes[0], nodes[4], nodes[5], nodes[1]]
      up = [nodes[2], nodes[6], nodes[7], nodes[3]]
      ...
      redside=[nodes[0][0]+1366/2,nodes[0][1]+768/2, nodes[1][0]+1366/2,nodes[1][1]+768/2, nodes[3][0]+1366/2,nodes[3][1]+768/2, nodes[2][0]+1366/2,nodes[2][1]+768/2]
      zeroZ=0
      oneZ=0
      twoZ=0
      threeZ=0
      ...
      for i in range(len(up)):
            fiveZ+=down[i][2]
      orderStr=['l', 'r', 'f', 'b', 'd', 'u']
      order=[zeroZ, oneZ, twoZ, threeZ, fourZ, fiveZ]
      order=sorted(zip(order, orderStr), key=lambda x: x[0])
      ...
      for i in order:
            ...
            if i[1] == "d":
                  pass
                  lop.append(canvas.create_polygon([nodes[2][0]+1366/2,nodes[2][1]+768/2, nodes[6][0]+1366/2,nodes[6][1]+768/2, nodes[7][0]+1366/2,nodes[7][1]+768/2, nodes[3][0]+1366/2,nodes[3][1]+768/2], fill="#0ff"))
            ...
            if i[1] == "r":
                  lop.append(canvas.create_polygon([nodes[4][0]+1366/2,nodes[4][1]+768/2, nodes[5][0]+1366/2,nodes[5][1]+768/2, nodes[7][0]+1366/2,nodes[7][1]+768/2, nodes[6][0]+1366/2,nodes[6][1]+768/2], fill="#006"))
            if i[1] == "f":
            ...
            if i[1] == "u":
                  lop.append(canvas.create_polygon([nodes[0][0]+1366/2,nodes[0][1]+768/2, nodes[4][0]+1366/2,nodes[4][1]+768/2, nodes[5][0]+1366/2,nodes[5][1]+768/2, nodes[1][0]+1366/2,nodes[1][1]+768/2], fill="#000"))
             #  l.append(p)
      canvas.update()
      canvas.delete("all")
#      nodeA.clear()
